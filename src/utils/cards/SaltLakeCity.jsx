...
import SaltLakeCity from '../../img/SaltLakeCity.jpg'; 

export default () => {

  return (
        <div className="location-card bg-secondary">
          <img className="image-head" alt="Salt Lake City" src={SaltLakeCity} />
          ...
          <table className="it-table-style">
            ...
            <tr className="it-table-row">
              ...
              <td className="table-content">Coffee Shops, The Lake</td>
            </tr>
            <tr className="it-table-row">
