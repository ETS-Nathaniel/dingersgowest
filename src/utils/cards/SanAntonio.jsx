...
import SanAntonio from '../../img/SanAntonio.jpg'; 

export default () => {

  return (
        <div className="location-card bg-secondary">
          <img className="image-head" alt="San Antonio" src={SanAntonio} />
          <h4 className="text-secondary">
            <strong>San Antonio</strong>
          </h4>
          <p className="text-faded mb-0">May 17-18</p>
          <table className="it-table-style">
            ...
            <tr className="it-table-row">
              ...
              <td className="table-content">The Alamo, River Walk</td>
            </tr>
            <tr className="it-table-row">
